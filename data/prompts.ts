...
export const PROMPT_LIBRARY: PromptCategory[] = [
    {
        ...
        prompts: [
            ...
            {
                id: "minimal-crypto",
                titleEn: "Minimal Crypto",
                titleAr: "كريبتو بسيط",
                descriptionEn: "Clean Bitcoin dashboard",
                descriptionAr: "لوحة بيتكوين بسيطة",
                valueEn: "Clean minimalist crypto wallet dashboard showing Bitcoin charts and transaction history. White background, light gray cards, focused typography. Line chart with subtle green gradient. Bottom action sheet for sending crypto. Style: Minimalist, Airy, Professional.",
                valueAr: "لوحة تحكم محفظة عملات رقمية بتصميم بسيط ونظيف. خلفية بيضاء، بطاقات رمادية فاتحة، وخطوط واضحة. رسم بياني خطي بتدرج أخضر ناعم. قائمة سفلية لإرسال العملات. التصميم: بسيط (Minimalist)، واسع، واحترافي.",
            },
        ],
    },
    {
        ...
        prompts: [
            ...
            {
                id: "streetwear-store",
                titleEn: "Streetwear Fashion",
                titleAr: "متجر أزياء شبابية",
                descriptionEn: "Modern urban clothing store",
                descriptionAr: "متجر ملابس شبابية وعصرية",
                valueEn: "Modern streetwear fashion store app, dark mode. Showing trendy youth clothing, sneakers, and oversized hoodies. Hero section with edgy typography. Grid of product cards with black background and neon accents. Style: Urban, Bold, Youthful.",
                valueAr: "متجر أزياء شبابية عصري، وضع داكن. يعرض ملابس شبابية، أحذية رياضية، وسترات واسعة (Hoodies). قسم رئيسي بتصاميم جريئة. شبكة منتجات بخلفية سوداء ولمسات نيون. التصميم: حضري، جريء، وشبابي.",
            },
            {
                id: "egyptian-restaurant",
                titleEn: "Egyptian Restaurant",
                titleAr: "مطعم مصري",
                descriptionEn: "Traditional food delivery",
                descriptionAr: "توصيل مأكولات شعبية",
                valueEn: "Traditional Egyptian food delivery app serving Koshary and Ta'amiya. Warm aesthetic with authentic patterns. Menu list with photos of delicious Koshary bowls. 'Order Now' button in primary orange. Style: Cultural, Warm, inviting.",
                valueAr: "تطبيق مطعم مأكولات شعبية مصرية يقدم الكشري والطعمية. طابع دافئ مع نقوش تراثية. قائمة الطعام تعرض صور أطباق كشري شهية. زر 'اطلب الآن' باللون البرتقالي الأساسي. التصميم: ثقافي، دافئ، ومرحّب.",
            },
            {
                id: "gaming-store",
                titleEn: "Gaming Setup Store",
                titleAr: "متجر ألعاب إلكترونية",
                descriptionEn: "Consoles and accessories market",
                descriptionAr: "سوق أجهزة الألعاب والإكسسوارات",
                valueEn: "Gaming store app selling PS5 consoles, mechanical keyboards, and RGB setups. Cyberpunk neon aesthetic (Purple/Green). Product cards with glowing borders. detailed specs view. Style: Futuristic, High-tech, Dark mode.",
                valueAr: "متجر ألعاب لبيع منصات PS5، لوحات مفاتيح ميكانيكية، وتجهيزات RGB. طابع سايبربانك نيون (بنفسجي/أخضر). بطاقات منتجات بحواف مضيئة. عرض تفاصيل المواصفات. التصميم: مستقبلي، عالي التقنية، ووضع داكن.",
            },
        ],
    },
    {
